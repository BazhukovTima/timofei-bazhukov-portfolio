...
CLASS zcl_info IMPLEMENTATION.
  ...
  METHOD get_description.
    rv_description = 'Experienced SAP professional with 10+ years in technical leadership, SAP development, system integration, and cross-platform mobile app creation.'.
  ENDMETHOD.
  ...
  METHOD get_about_expertise.
    rv_line = 'More than 10 years in SAP engineering roles, including senior and technical leadership positions. Deep expertise in SAP development, system integration, and fostering best coding practices within the SAP ecosystem.'.
  ENDMETHOD.
  ...
  METHOD get_about_technical_stack.
    rv_line = 'Advanced skills in SAP technologies: SAP Fiori, SAPUI5, ABAP (transactions, enhancements), OData/SOAP web services, SAP Business Technology Platform (BTP), and database management including HANA and MongoDB.'.
  ENDMETHOD.

  METHOD get_about_focus.
    rv_line = 'Driving SAP governance, architecture, and cybersecurity initiatives, ensuring alignment with modern digital platform principles and enterprise standards.'.
  ENDMETHOD.

  METHOD get_about_mobile.
    rv_line = 'Experienced in developing cross-platform mobile applications with React Native, Flutter, and Node.js, published on both App Store and Google Play.'.
  ENDMETHOD.

  METHOD get_about_soft_skills.
    rv_line = 'Effective leader and collaborator, skilled in business analysis, project management, and technical architecture, with a strong background in Supply Chain and scalable solution design.'.
  ENDMETHOD.
  ...
  METHOD get_experience_h.
    rv_line = 'A curated selection of key projects across SAP and non-SAP domains. Each showcases hands-on development, architectural insight, and business impact through practical engineering solutions.'.
  ENDMETHOD.
