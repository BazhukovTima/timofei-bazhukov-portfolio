"use strict";
(self["webpackChunkabap2ui5_minimal"] = self["webpackChunkabap2ui5_minimal"] || []).push([["output_cl_abap_zip_clas_locals_mjs"],{
...
class lcl_stream {
  ...
  async append_crc(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.xstrlen({val: lcl_stream.crc32_map}), abap.IntegerFactory.get(0))) {
      ...
      const unique241 = new abap.types.Integer().set(256).get();
      for (let unique242 = 0; unique242 < unique241; unique242++) {
        abap.builtin.sy.get().index.set(unique242 + 1);
        ...
        const unique243 = abap.IntegerFactory.get(8).get();
        for (let unique244 = 0; unique244 < unique243; unique244++) {
          abap.builtin.sy.get().index.set(unique244 + 1);
    ...
    const unique245 = len.get();
    for (let unique246 = 0; unique246 < unique245; unique246++) {
      abap.builtin.sy.get().index.set(unique246 + 1);
...
//# sourceMappingURL=chunk_output_cl_abap_zip_clas_locals_mjs.bundle.js.map