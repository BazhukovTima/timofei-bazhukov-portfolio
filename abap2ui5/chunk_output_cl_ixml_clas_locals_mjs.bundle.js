"use strict";
(self["webpackChunkabap2ui5_minimal"] = self["webpackChunkabap2ui5_minimal"] || []).push([["output_cl_ixml_clas_locals_mjs"],{
...
class lcl_named_node_map {
  ...
  async if_ixml_named_node_map$get_named_item_ns(INPUT) {
    ...
    for await (const unique278 of abap.statements.loop(this.mt_list)) {
      li_node.set(unique278);
...
class lcl_node {
  ...
  async if_ixml_element$find_from_name_ns(INPUT) {
    ...
    for await (const unique279 of abap.statements.loop(lt_nodes)) {
      li_top.set(unique279);
      ...
      let unique280 = 1;
      while (true) {
        abap.builtin.sy.get().index.set(unique280++);
  ...
  async if_ixml_element$render(INPUT) {
    ...
    let unique282 = 1;
    while (true) {
      abap.builtin.sy.get().index.set(unique282++);
...
//# sourceMappingURL=chunk_output_cl_ixml_clas_locals_mjs.bundle.js.map